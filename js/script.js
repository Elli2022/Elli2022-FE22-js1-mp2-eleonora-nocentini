...
function handleGuess(event) {
    ...
    if (compGuess == 1) {
        h2ComputerChoice.innerText = 'Computer: Rock';
    }
    else if (compGuess == 2) {
        h2ComputerChoice.innerText = 'Computer: Paper';
    }
    else if (compGuess == 3) {
        h2ComputerChoice.innerText = 'Computer: Scissor';
    }

    if (event.target.id == 'sten-user') {
        userGuess = 1;
        h2UserChoice.innerText = nameInput.value + '' + ': Rock';
    }
    else if (event.target.id == 'pase-user') {
        userGuess = 2;
        h2UserChoice.innerText = nameInput.value + '' + ': Paper';
    }
    else if (event.target.id == 'sax-user') {
        userGuess = 3;
        h2UserChoice.innerText = nameInput.value + '' + ': Scissor';
    }
